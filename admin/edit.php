<?php  
 ...
 if (isset($_GET['logout'])) {
  ...
  $product= $product_id->edit($id);
  $query_id= mysqli_fetch_assoc($product);

  if (isset($_POST['btn'])) {
    require_once '../class/class_product_info.php';
    $product_info=new cls_product_info();
    $product_info->update($_FILES, $_POST);
  }
               ...
               <div class="well">
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_title" value="<?php echo $query_id['product_title']; ?>" class="form-control" id="inputEmail3" placeholder="Title....">
                      <input type="hidden" name="product_id" value="<?php echo $query_id['product_id']; ?>" class="form-control" id="inputEmail3" placeholder="Title....">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Price :</label>
                    <div class="col-sm-10">
                      <input type="text" name="product_price" value="<?php echo $query_id['product_price']; ?>" class="form-control" id="inputPassword3" placeholder="Price...">
                    </div>
                  </div>
                 <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Image :</label>
                    <div class="col-sm-3">
                      <img src="<?php echo $query_id['product_image']; ?>" class="img-fluid" alt="Cinque Terre">
